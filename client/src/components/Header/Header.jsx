    ...
    render() {
        return (
            <div className={style.headerx}>
                ...
                <img onClick={this.returnHome} className={style.logo} src="https://i.postimg.cc/3N5t68fJ/Logo-Henry-Food.png" alt="logo" />
                    ...
                    (this.props.location.pathname === "/recipes/create")
                        ...
                        (<>
                            ...
                            <form onSubmit={this.searchSubmit} className={style.search}>
                                <input placeholder='Recipes' type="text" className={style.input} value={this.state.inputValue} onChange={this.changeHandler}/>
                                <input className={style.btn} value={"Buscar"} type="submit" />
                            </form>
                        </>)
                    }
                </div>
